 ...
 */
class ScanSetting {
    static final String PLUGIN_NAME = "com.strod.module"
    /**
     * The register code is generated into this class
     */
    static final String GENERATE_TO_CLASS_NAME = 'com/strod/moduleinit/api/ModuleInitManager'
    /**
     ...
     */
    static final String ROUTER_CLASS_PACKAGE_NAME = 'com/strod/moduleinit/ModuleInit$$Root'
    /**
     * The package name of the interfaces
     */
    private static final INTERFACE_PACKAGE_NAME = 'com/strod/moduleinit/api/core/'
    ...
    /**
     * constructor for moduleinit-auto-register settings
